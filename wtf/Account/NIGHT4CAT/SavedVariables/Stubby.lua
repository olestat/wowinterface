...
StubbyConfig = {
	["addinfo"] = {
		["Enchantrix"] = "Enchantrix|Display information in item tooltips pertaining to disenchanting, prospecting, and milling results.  [5.9.4960] This AddOn is licensed under the GNU GPL, see GPL.txt for details.",
		["Informant"] = "Informant|Displays detailed item information in tooltips, such as use, vendor sales information, and more.  In additon, extended information can be viewed by binding a key from the keybind menu. [5.9.4960] This AddOn is licensed under the GNU GPL, see GPL.txt for details.",
	},
	["inspected"] = {
		["Enchantrix"] = true,
		["Informant"] = true,
	...
	["boots"] = {
		["enchantrix"] = {
			...
			["triggers"] = "		if Stubby.GetConfig(\"Enchantrix\", \"LoadType\") == \"always\" then\n			LoadAddOn(\"Enchantrix\")\n		else\n			Stubby.Print(\"Enchantrix не загружен. Напечатайте /enchantrix для большей информации.\n\")\n		end\n	",
		},
		["informant"] = {
			...
			["triggers"] = "		local loadType = Stubby.GetConfig(\"Informant\", \"LoadType\")\n		if (loadType == \"always\") then\n			LoadAddOn(\"Informant\")\n		else\n			Stubby.Print(\"Informant не загружен. Введите /informant для получения информации\");\n		end\n	",
		},
	},
	["configs"] = {
		["enchantrix"] = {
			["эларин:loadtype"] = "always",
			["лафариэль:loadtype"] = "always",
		},
		["informant"] = {
			["loadtype"] = "always",
		},
