...
L["Advanced Targeting"] = "Fortgeschrittenes Zielen"
L["Alpha"] = "Transparenz"
...
L["Control the targets of your actions based on advanced macro conditions."] = "Steuere die Ziele Deiner Aktionen, basierend auf fortgeschrittenen Makro-Bedingungen."
...
L["Griffin"] = "Greif"
L["Hide Equipped Border"] = "Ausgerüsteten Rand verbergen"
...
L["Hide the inner border indicating the equipped status on the buttons of this bar."] = "Den inneren Rand verbergen, um den ausgestatteten Status auf den Schaltflächen dieser Leiste anzuzeigen."
L["Hide this bar in a specific Stance or Form."] = "Diese Leiste in einer bestimmten Haltung oder Form verstecken."
L["Hide this bar when the game wants to show a vehicle UI."] = "Verberge diese Leiste, wenn das Spiel das Fahrzeug-UI anzeigen will."
...
L["Hide with Vehicle UI"] = "Verberge mit Fahrzeug-UI"
