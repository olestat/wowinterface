...
L["Advanced Targeting"] = "Objetivos avanzados"
...
L["Control the targets of your actions based on advanced macro conditions."] = "Controla los objetivos de tus barras de accion desde condiciones avanzadas de macros."
...
L["Its simple! Just check the Keyring option in the BagBars configuration menu, and it'll appear next to your bags."] = "Es sencillo!! Solo marca la opción del llavero en el menú de configuración de Barra de Bolsas, y aparecerá al lado de tus bolsas."
...
L["My BagBar does not have the Keyring on it, how do i get it back?"] = "Mi Barra de Bolsas no tiene el llavero en ella, como la vuelvo a tener?"
...
L["The background of button places where no buttons are placed"] = "El fondo de los huecos de los botones cuando no hay botones puestos" -- Needs review
