...
L["Advanced Targeting"] = "Ciblage avancé"
...
L["Anchor"] = "Ancre"
L["Apply Preset"] = "Appliquer les préétablis"
...
L["Control the targets of your actions based on advanced macro conditions."] = "Contrôle les cibles de vos actions selon des conditions avancées de macro."
...
L["Its simple! Just check the Keyring option in the BagBars configuration menu, and it'll appear next to your bags."] = "C'est simple ! Cochez l'option Trousseau de clés dans le menu de configuration de la barre des sacs, et il apparaîtra à côté de vos sacs."
...
L["My BagBar does not have the Keyring on it, how do i get it back?"] = "Ma barre des sacs ne contient pas le trousseau de clés, comment puis-je le récupérer ?"
...
L["Toggles actions immediately when you press the key, and not only on release. Note that draging actions will cause them to be cast in this mode."] = "Effectue ou non les actions immédiatement après que vous ayez appuyé sur la touche, et pas uniquement quand vous l'avez relâchée Notez que les actions de saisie seront incantés dans ce mode."
