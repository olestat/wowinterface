...
L["TITAN_UISCALE_MENU_TEXT_SHORT"] = "Управление панелью";
...
-- Engineering
"Тяжелый ящик с инструментами", "Ящик для инструментов из оскверненного железа", "Титановый ящик с инструментами", "Кориевый ящик с инструментами", 
-- not sure the "Khorium Toolbox" is used anymore
-- Herbalism
"Мешочек для трав", "Кенарийская сумка для трав", "Сумка Кенария", "Ботаническая сумка Микаа", "Изумрудный вьюк",
-- Inscription
"Сумка начертателя", "Рюкзак с бесчисленными карманами",
-- Jewelcrafting
"Мешочек для самоцветов", "Мешочек для драгоценностей",
-- Leatherworking
"Сумка кожевника", "Сумка множества шкур", "Походная сума зверолова",
-- Mining
"Шахтерский мешок", "Укрепленная шахтерская сумка", "Шахтерская сумка из шкуры мамонта",
};
