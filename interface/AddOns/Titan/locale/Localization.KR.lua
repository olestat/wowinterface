...
L["TITAN_MOVABLE_TOOLTIP"] = "드래그해서 이동";

L["TITAN_PANEL_ERROR_DUP_PLUGIN"] = " 두번 등록되었습니다. 이것은 플러그인의 동작을 보장하지 않습니다. 이문제를 제작자에게 알려주십시오.";
...
--L["TITAN_PANEL_CHARS_DELETE_BUTTON"] = "캐릭터 데이터 삭제"
--L["TITAN_PANEL_CHARS_DELETE_MSG"] = "캐릭터 데이터가 삭제되었습니다."
L["TITAN_PANEL_REGISTER_START"] = "타이탄 플러그인 등록..."
L["TITAN_PANEL_REGISTER_END"] = "프로세스 등록 완료"

-- slash command help
L["TITAN_PANEL_SLASH_STRING2"] = LIGHTYELLOW_FONT_COLOR_CODE.."사용법: |cffffffff/titan {reset | reset tipfont/tipalpha/panelscale/spacing}";
L["TITAN_PANEL_SLASH_STRING3"] = " - "..LIGHTYELLOW_FONT_COLOR_CODE.."reset: |cffffffff초기화 - "..TITAN_PANEL.." 기본 값 및 위치";
L["TITAN_PANEL_SLASH_STRING4"] = " - "..LIGHTYELLOW_FONT_COLOR_CODE.."reset tipfont: |cffffffff초기화 - "..TITAN_PANEL.."툴팁 글꼴 크기";
L["TITAN_PANEL_SLASH_STRING5"] = " - "..LIGHTYELLOW_FONT_COLOR_CODE.."reset tipalpha: |cffffffff초기화 - "..TITAN_PANEL.."툴팁 투명도";
L["TITAN_PANEL_SLASH_STRING6"] = " - "..LIGHTYELLOW_FONT_COLOR_CODE.."reset panelscale: |cffffffff초기화 - "..TITAN_PANEL.."크기";
L["TITAN_PANEL_SLASH_STRING7"] = " - "..LIGHTYELLOW_FONT_COLOR_CODE.."reset spacing: |cffffffff초기화 - "..TITAN_PANEL.."버튼 간격";
L["TITAN_PANEL_SLASH_STRING8"] = " - "..LIGHTYELLOW_FONT_COLOR_CODE.."gui control: |cffffffff열기 - "..TITAN_PANEL.." 패널 설정창";
L["TITAN_PANEL_SLASH_STRING9"] = " - "..LIGHTYELLOW_FONT_COLOR_CODE.."gui trans: |cffffffff투명도 설정창을 엽니다.";
L["TITAN_PANEL_SLASH_STRING10"] = " - "..LIGHTYELLOW_FONT_COLOR_CODE.."gui skin: |cffffffff스킨 설정창을 엽니다.";
...
--L["TITAN_PANEL_MENU_CUSTOMIZE"] = "자유 설정";
...
--L["TITAN_PANEL_MENU_BGMINIMAP"] = "전장 미니맵";
L["TITAN_PANEL_MENU_CENTER_TEXT"] = "중앙 글자";
L["TITAN_PANEL_MENU_DISPLAY_BAR"] = "바 표시";
--L["TITAN_PANEL_MENU_DISPLAY_BOTH"] = "양쪽 바에 표시";
...
--L["TITAN_PANEL_MENU_BUILTINS"] = "기본 내장";
--L["TITAN_PANEL_MENU_LEFT_SIDE"] = "왼쪽";
--L["TITAN_PANEL_MENU_RIGHT_SIDE"] = "오른쪽";
...
--L["TITAN_PANEL_MENU_DOUBLE_BAR"] = "이중 바";
...
--L["TITAN_PANEL_MENU_DISABLE_FONT"] = "글꼴 크기 조절 불가";
...
L["TITAN_TRANS_MAIN_BAR_DESC"] = "메인바(상단바)의 투명도를 조절합니다.";
L["TITAN_TRANS_AUX_BAR_DESC"] = "보조바(하단바)의 투명도를 조절합니다.";
...
--L["TITAN_SKINS_NAME_EXAMPLE"] = "예: 나의 타이탄 스킨";
L["TITAN_SKINS_PATH_TITLE"] = "스킨 경로";
L["TITAN_SKINS_PATH_DESC"] = "정확한 스킨 경로를 입력합니다(아래 예제를 참고하세요).";
--L["TITAN_SKINS_PATH_EXAMPLE"] = "예: Interface\\AddOns\\Titan\\Artwork\\Custom\\<내 스킨 폴더>\\";
...
--L["TITAN_SKINS_NOTES"] = "|cff19ff19노트:|r 스킨을 추가할 때, 와우가 설치된 폴더에 파일이 위치해야합니다.";
...
--L["TITAN_AUTOHIDE_MENU_TEXT"] = "자동 숨김";
...
--L["TITAN_BAG_MENU_IGNORE_AMMO_POUCH_SLOTS"] = "탄환 가방 제외";
--L["TITAN_BAG_MENU_IGNORE_SHARD_BAGS_SLOTS"] = "조각 가방 제외";
L["TITAN_BAG_MENU_IGNORE_PROF_BAGS_SLOTS"] = "전문기술 가방 제외";
--L["TITAN_BAG_SHARD_BAG_NAMES"] = {"영혼의 주머니", "작은 영혼의 가방", "영혼의 용기", "지옥매듭 가방", "화산핵 지옥매듭 가방", "칠흑의 암흑 가방", "심연의 가방"};
--L["TITAN_BAG_AMMO_POUCH_NAMES"] = {"갈래발굽가죽 화살통", "늑대가죽 화살통", "힘줄 감긴 고대의 잎주머니", "네루비안 강화 화살통", "천 개의 깃털 화살통", "코도가죽 화살통", "하피 가죽 화살통", "리블리의 화살통", "속사 화살통", "두꺼운 가죽 화살통", "어둠의 순찰대 화살통", "사냥용 화살통", "일반 화살통", "얇은 가죽 화살통", "작은 화살통", "가벼운 화살통", "밀수업자의 탄약주머니", "용비늘 탄약주머니", "코도가죽 탄약주머니", "황천비늘 탄약주머니", "놀 가죽 탄띠", "리블리의 탄띠", "두꺼운 가죽 탄약주머니", "질긴 가죽 탄약주머니", "어둠의 순찰대 탄약주머니", "일반 탄환 주머니", "사냥용 탄환 주머니", "작은 가죽 탄약주머니", "작은 탄환 주머니", "작은 탄약주머니"};
L["TITAN_BAG_PROF_BAG_NAMES"] = {
-- Enchanting
"마력 깃든 마법매듭 가방", "마력 깃든 룬매듭 가방", "큰 마법용품 가방", "마법부여사의 가방", "불가사의한 가방", "마법불꽃 가방",
-- Engineering
"티타늄 연장통", "지옥무쇠 연장통", "무거운 공구함",
-- not sure the "Khorium Toolbox" is used anymore
-- Herbalism
"약초 주머니", "세나리온 약초 가방", "세나리우스의 주머니", "미카의 채집용 주머니", "에메랄드 가방",
-- Inscription
"주문각인사의 가방", "무한 주머니 가방",
-- Jewelcrafting
"보석 주머니", "보석 자루",
-- Leatherworking
"가죽세공인의 가방", "가죽 덧댄 가방", "덫사냥꾼의 여행 가방",
-- Mining
"강화된 채광용 자루", "채광용 자루", "매머드 채광 자루",
};

--L["TITAN_BGMINIMAP_MENU_TEXT"] = "전장 미니맵"
--L["TITAN_BGMINIMAP_TOOLTIP"] = "전장 미니맵을 전환합니다."
...
L["TITAN_LATENCY_TOOLTIP_LATENCY"] = "지연시간: ";
...
L["TITAN_PERFORMANCE_MENU_SHOW_LATENCY"] = "지연시간 표시";
