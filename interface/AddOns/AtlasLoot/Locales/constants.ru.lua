...
if AL then
	...
	--AL["Vanity Pets"] = "Не-Боевые питомци"; --changed
	...
	-- Pets
	AL["Pets"] = "Питомци";
	--AL["Promotional"] = "Содействующие"; --changed
	--AL["Pet Store"] = "Магазин питомцев"; --changed
	--AL["Merchant Sold"] = "Продаються торговцами"; --changed
	AL["Rare"] = "Редкий";
