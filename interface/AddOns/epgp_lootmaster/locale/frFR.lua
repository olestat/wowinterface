...
L["** MONITOR ONLY **"] = "** RESPONSABLE UNIQUEMENT**"
...
L["Announce loot & request bids"] = "Annoncer les loots et demander les jets d\195\169s"
...
L["Disallow voting for self"] = "Emp\195\170che de voter pour sois-m\195\170me"
...
L["Give loot and award %s GP Bid"] = "Donner l'objet et recompens\195\169 %s GP Offre"
...
L["Manual, disable bidding when auto announcing"] = "Manue, d\195\169sactiver les offres quand il y a une annonce automatique."
...
L["Only send to promoted players in raid"] = "Seulement envoyer au joueurs assistants dans le raid"
L["Only send to specific guildranks"] = "Envoyer seulement au rangs de guilde sp\195\169cifiques "
L["Only send to the following guildranks:"] = "Seulement envoyer au rangs de guilde suivants:"
...
L["Please click this button to vote for %s for the selected item"] = "Cliquer sur ce bouton pour %s pour l'objet s\195\169lectionn\195\169"
...
L["Registered bid %d, %s for %s"] = "Enregistrer l'offre %d,%s for %s"
...
L["Serious error in class bitdecoder, bits %s not found. Please make sure you have the latest version installed and report if problem persists."] = "S\195\169rieuse erreur dans le bitdecoder de classes , bits% non trouv\195\169es . Soyer sur que vous avez la derniere version disponible instal\195\169e et faire un rapport si le probl\195\168me persiste. "
L["Serious error in class bitencoder, class %s not found. Please make sure you have the latest version installed and report if problem persists."] = "S\195\169rieuse erreur dans le bitdecoder de classes , bits% non trouv\195\169es . Soyer sur que vous avez la derniere version disponible instal\195\169e et faire un rapport si le probl\195\168me persiste. "
...
L["The bidding system is a variation of the EPGP system where loot candidates are allowed to bid a custom GP value per item. The highest GP bid wins the loot."] = "Le syst\195\168me d'offres est une variation du syst\195\168me EPGP  la ou les candidats sont autoris\195\169 a donner une offre GP par objet . L'offre la plus grande gagn\195\169 l'objet"
L["The following players have voted for %s:"] = "Les joueurs suivants on vot\195\169s pour %s:"
L["The voting system allows the master looter to request help when making a decision. While this is not something that's encouraged by the EPGP system as it will slow down the looting process a little, it will provide a guild much more flexibility. The master can request a vote per item at any time by a simple press of a button."] = "Le syst\195\168me de vote autorise le maitre du butin de demander de l'aide quand il prend une d\195\169cision. Ceci est cependant pas recommander par le syst\195\168me EPGP car cela ralentira le syst\195\168me de loot , mais il donnera une meilleure flexibilit\195\169 a la guilde . Le maitre du butin peut requ\195\169rir un vote par item a n'importe quel moment en cliquant sur le bouton de jet de d\195\169s."
L["The voting system allows the master looter to request help when making a decision. While this is not something that's encouraged by the EPGP system as it will slow down the looting process a little, it will provide a guild much more flexibility. The master looter can request a vote per item at any time by a simple press of a button."] = "Le syst\195\168me de vote autorise le maitre du butin de demander de l'aide quand il prend une d\195\169cision. Ceci est cependant pas recommander par le syst\195\168me EPGP car cela ralentira le syst\195\168me de loot , mais il donnera une meilleure flexibilit\195\169 a la guilde . Le maitre du butin peut requ\195\169rir un vote par item a n'importe quel moment en cliquant sur le bouton de jet de d\195\169s."
L["The voting system has been disabled or no votes have been requested. You can enable the voting system from the configuration panel and you can request votes by pressing the [Request Votes] button if you are the master looter"] = "Le syst\195\168me de vote a \195\169t\195\169 d\195\169sactiv\195\169 ou aucun votes n'ont \195\169t\195\169 demand\195\169s . Vous pouvez activ\195\169 le syst\195\168me de vote depuis le panel de configuration et vous pouvez requ\195\169rir a un vote en cliquant sur le bouton [Demander un vote ] si vous \195\170tes le chef de butin"
...
L["When should bidding be available to player?"] = "Quand es-ce que les demandes d'offres  seront disponibles au joueurs ?"
L["Whisper"] = "Wisp"
